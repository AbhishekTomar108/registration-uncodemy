...
function StudentAttandanceDetails() {
  ...
  const getAttendance = async(student) => {
    ...
    let filterStatus = await fetch("https://registration-backend2.onrender.com/getMonthAttendance", {
      method: "POST",
  ...
  const getstudent = async () => {
    let res = await fetch(`https://registration-backend2.onrender.com/getuser/${id}`, {
      method: "GET",
      headers: {
