...
useEffect(()=>{
  ...
  const getCounselorStudent = async(id)=>{
    ...
    let CounselorStudent = await fetch('https://registration-backend2.onrender.com/getStudentByCounselor', {
      method: 'POST',
  ...
  const showMessagedialog = async (id) => {
    ...
    let sendData = await fetch('https://registration-backend2.onrender.com/sendmessage', {
      method: 'POST',
      headers: { "Content-Type": "application/json" },
  ...
  //   let studentData = await fetch('https://registration-backend2.onrender.com/getStudentByCounselor', {
  //     method: 'POST',
  //     headers: { "Content-Type": "application/json" },
  ...
  const deleteuser = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://registration-backend2.onrender.com/deleteuser/${id}`, {
          method: "DELETE",
          headers: {
