...
function FeeTable() {
  ...
  const getTrainerdata = async () => {
    const res = await fetch("https://registration-backend2.onrender.com/FeeTable", {
      method: "GET",
      headers: {
  ...
  const deleteuser = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://registration-backend2.onrender.com/deleteFee/${id}`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json"
          }
  ...
  const getAllStudentPaymentStatus =async()=>{
    ...
    let studentPaymentStatus = await fetch("https://registration-backend2.onrender.com/getStudentFeesStatus")
  ...
  const SearchStudentFees = async()=>{
    ...
    let getRangeFees = await fetch("https://registration-backend2.onrender.com/getRangeFees",{
      method:"GET",
      headers:{
