...
//         email: 'google-sheet-data@psyched-timer-409706.iam.gserviceaccount.com',
//         key: '-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n',
//         scopes: [
//           'https://www.googleapis.com/auth/spreadsheets',
//         ],
//       });

//     const doc = new GoogleSpreadsheet('1nHretEmgLVuRJCdo4qsSHVIKBH32uQhJlXaFou4KpPU', serviceAccountAuth);
...
router.post("/google-sheet-data",async(req,res) =>{
    ...
    const sheet = doc.sheetsByIndex[0];
      ...
      const HEADERS = ['BatchMode','Counselor','CounselorId','Course','CourseFees','Name','Email','Number','PaymentMethod','PaymentMode','Pname','Pnumber','RegistrationDate','RegistrationFees','RegistrationNo','Remark','joinDate','joinTime','subCourse','totalInstallment']
      await sheet.setHeaderRow(HEADERS)
