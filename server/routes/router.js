...
router.post("/google-sheet-data",async(req,res) =>{
    ...
    const sheet = doc.sheetsByIndex[0];
      ...
      const HEADERS = ['BatchMode','Counselor','CounselorId','counselorNumber','Course','CourseFees', 'RemainingFees','Name','Email','Number','PaymentMethod','PaymentMode','Pname','Pnumber','RegistrationDate','RegistrationFees','RegistrationNo','Remark','joinDate','joinTime','subCourse','totalInstallment']
      await sheet.setHeaderRow(HEADERS)
